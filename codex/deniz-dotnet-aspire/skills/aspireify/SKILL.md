...
description: "**WORKFLOW SKILL** - Wire Aspire AppHosts or repair TypeScript
  ...
  or Yarn Classic. DO NOT USE FOR: skeleton drop
  ($deniz-dotnet-aspire:aspire-init), lifecycle-only start/stop/wait/restart or
  `aspire update --migrate` ($deniz-dotnet-aspire:aspire-orchestration),
  publish/deploy/destroy ($deniz-dotnet-aspire:aspire-deployment), logs/traces
  ($deniz-dotnet-aspire:aspire-monitoring). INVOKES: aspire CLI, AppHost source
  edits, ServiceDefaults wiring. FOR SINGLE OPERATIONS: Run `aspire add PACKAGE`
  direct..."
license: MIT
metadata:
  author: Microsoft

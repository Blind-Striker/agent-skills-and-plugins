...
- Adding or configuring `WithBrowserLogs()` is AppHost authoring; route that work to `$deniz-dotnet-aspire:aspireify`.
...
Adding or configuring `WithBrowserLogs()` remains AppHost authoring and routes to `$deniz-dotnet-aspire:aspireify`.

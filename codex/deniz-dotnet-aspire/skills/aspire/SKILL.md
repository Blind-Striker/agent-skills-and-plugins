...
description: "**WORKFLOW SKILL** - Aspire 13.5.3 router. Detects AppHosts,
  ...
  non-Aspire projects or ordinary build/test tasks. INVOKES:
  $deniz-dotnet-aspire:aspire-init, $deniz-dotnet-aspire:aspireify,
  $deniz-dotnet-aspire:aspire-orchestration,
  $deniz-dotnet-aspire:aspire-deployment,
  $deniz-dotnet-aspire:aspire-monitoring. FOR SINGLE OPERATIONS: Route directly

...
description: '**WORKFLOW SKILL** — Manage Aspire lifecycle in VS Code or the
  ...
  fallbacks. DO NOT USE FOR: deploy/publish/destroy (aspire-deployment),
  logs/traces/metrics (aspire-monitoring), or AppHost code and resource
  wiring (aspireify). FOR SINGLE OPERATIONS: Load the matching editor

...
description: "**ANALYSIS SKILL** - Observe Aspire apps: logs, traces, metrics,
  ...
  aspire-orchestration), deploy/publish/destroy (use
  aspire-deployment), AppHost code edits like WithBrowserLogs() (use
  aspireify), Azure provisioning (use azure-prepare). INVOKES: aspire

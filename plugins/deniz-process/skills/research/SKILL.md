...
Craft its dispatch the way the deniz-process:dispatching-parallel-agents skill teaches: focused
scope, self-contained context, and an explicit expected output.

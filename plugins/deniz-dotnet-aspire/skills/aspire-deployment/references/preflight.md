...
3. If `aspire ls` shows no AppHosts, stop deployment work and invoke the `deniz-dotnet-aspire:aspireify` skill to initialize/wire the AppHost before continuing.

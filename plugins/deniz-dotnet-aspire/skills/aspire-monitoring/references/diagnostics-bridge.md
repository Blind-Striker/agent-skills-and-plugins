...
│
├── YES → Route to deniz-dotnet-aspire:aspire-deployment skill (and deniz-dotnet-aspire:aspireify for code edits)
│
...
| Add `WithBrowserLogs()` to a resource | → **`deniz-dotnet-aspire:aspireify` skill** (AppHost authoring) |
